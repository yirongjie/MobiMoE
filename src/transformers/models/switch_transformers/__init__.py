...
try:
    ...
    _import_structure["modeling_switch_transformers"] = [
        ...
        "SwitchTransformersModelYRJ",
        "SwitchTransformersForConditionalGenerationYRJ",
        "ExpertManager",
        "LoadFunc", "globalMultiEvent", "globalMultiThreadRun", "globalMultiParam", "globalEM","globalMultiLock",
