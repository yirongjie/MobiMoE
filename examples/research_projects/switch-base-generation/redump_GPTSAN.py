...
model_dict = torch.load(os.path.dirname(os.path.realpath(__file__))+'/models/GPTSAN-japanese/pytorch_model.bin')
...
dir_cpu= os.path.dirname(os.path.realpath(__file__))+'/models/GPTSAN-japanese-yrj/cpu/'
if not os.path.isdir(dir_cpu):
    os.mkdir(dir_cpu)
dir_gpu= os.path.dirname(os.path.realpath(__file__))+'/models/GPTSAN-japanese-yrj/cuda/'
...
#     print(key)
torch.save(t5_model_dict, os.path.dirname(os.path.realpath(__file__))+'/models/GPTSAN-japanese-yrj/pytorch_model.bin')
